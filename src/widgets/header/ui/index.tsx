        ...
        {payload ? (
          <Sheet modal={false}>
            ...
            <SheetContent className="text-white">
              <SheetHeader>
                <SheetTitle hidden className="text-2xl font-bold text-white">
                  Profile
                </SheetTitle>
                <SheetDescription hidden className="text-gray-300 text-[14px">
                  Hi <span className="text-gold">KINGSMAN</span> 💈 Keep track
                  of your appointments, explore your grooming history, and stay
                  sharp with style made for kings.
                </SheetDescription>
              </SheetHeader>
              <AppointmentSidebar />
              <SheetFooter className="mt-auto">
                <Button
                  ...
                  variant="outline"
                  className="flex items-center justify-center w-full cursor-pointer text-white"
                >
                  <LogOut /> Logout
                </Button>
          ...
          <Link href={paths.register}>
            <Button className="bg-accent text-base font-jockey cursor-pointer">
              Sign Up
            </Button>
          </Link>
        )}
