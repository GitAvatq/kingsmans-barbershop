...
export const ReviewCard = ({
  ...
  return <div className="flex flex-col items-start gap-6 max-w-full h-96 text-start bg-background p-10 rounded-2xl relative">
    ...
    <h4 className="text-xl font-bold text-[#E9C664]">
      {name}
    </h4>
    ...
    <div className="flex w-full justify-between items-center absolute bottom-3 left-0 px-6">
      ...
      <div>
        <p className="text-white text-xs text-start">{date}{" "}{time}</p>
